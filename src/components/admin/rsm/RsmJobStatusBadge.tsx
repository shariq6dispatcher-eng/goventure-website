const JOB_STATUS_STYLES: Record<string, string> = {
  ...
  "Start Digitizing": "bg-amber-950 text-amber-300 border-amber-900",
  Completed: "bg-emerald-950 text-emerald-300 border-emerald-900",
  Delivered: "bg-blue-950 text-blue-300 border-blue-900",
};

export default function RsmJobStatusBadge({ status }: { status: string }) {
  const style =
    JOB_STATUS_STYLES[status] || "bg-zinc-900 text-zinc-300 border-zinc-800";
