...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      RegExp("\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:body|div|main|section|article|aside|header|footer|nav|form|p|span|h1|h2|h3|h4|h5|h6) \\(<anonymous>\\))[\\s\\S])*?\\n\\s+at __next_root_layout_boundary__ \\([^\\n]*\\)"), RegExp("\\n\\s+at __next_metadata_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_viewport_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_outlet_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_instant_validation_boundary__[\\n\\s]"), e.s(["config", 0, { matcher: ["/admin/:path*"] }, "middleware", 0, function(e10) {
        let t10 = e10.cookies.get("admin-auth"), r2 = e10.nextUrl.pathname.startsWith("/admin");
        return (console.log("MIDDLEWARE HIT:", e10.nextUrl.pathname), r2 && !t10) ? es.redirect(new URL("/admin-login", e10.url)) : es.next();
      }], 99446);
